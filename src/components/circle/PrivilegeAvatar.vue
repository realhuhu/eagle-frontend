...
const avatar_outer = computed(() => {
  ...
  switch (props.privilege_type) {
    case 1:
      ...
      break
    case 2:
      image = proxy_url("https://i0.hdslb.com/bfs/live/3b46129e796df42ec7356fcba77c8a79d47db682.png@56w_56h.webp")
      break
    case 3:
      image = proxy_url("https://i0.hdslb.com/bfs/live/a454275dea465ac15a03f121f0d7edaf96e30bcf.png@56w_56h.webp")
      break
  }
